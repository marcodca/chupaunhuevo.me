...
const shadows = css`
  :root {
    --elevation-0: 0 0.9px 1.5px -26px rgba(0, 0, 0, 0.028),
      0 2.2px 3.7px -26px rgba(0, 0, 0, 0.04),
      0 4.1px 7px -26px rgba(0, 0, 0, 0.05),
      0 7.4px 12.5px -26px rgba(0, 0, 0, 0.06),
      0 13.8px 23.4px -26px rgba(0, 0, 0, 0.072),
      0 33px 56px -26px rgba(0, 0, 0, 0.1);
